...
@available(iOS 16.0, *)
public class Cosmr1CredentialHandlerModule: Module  {
  
  // MARK: - Properties
  private var credentialManager: CredentialManager?
  
  public func definition() -> ModuleDefinition {
    Name("Cosmr1CredentialHandler")
    ...
    AsyncFunction("authenticate") { (
      ...
      return try await authenticate(getOptions: getOptions, prefersImmediatelyAvailableCred: prefersImmediatelyAvailableCred)
    }
    ...
    AsyncFunction("register") { (
      ...
      return try await register(createOptions: createOptions, prefersImmediatelyAvailableCred: prefersImmediatelyAvailableCred)
    }
  }
  ...
  private func authenticate(getOptions: GetCredentialOptions, prefersImmediatelyAvailableCred: Bool) async throws -> [String: Any]? {
  ...
  private func register(createOptions: CreateCredentialOptions, prefersImmediatelyAvailableCred: Bool) async throws -> [String: Any]? {
